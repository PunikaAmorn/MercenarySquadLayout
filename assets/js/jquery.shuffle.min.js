...
var shuffleme = (function($) {
    'use strict';
    var $grid = $('[id*="grid"]'), //locate what we want to sort
        $filterOptions = $('.portfolio-tab-sorting li'), //locate the filter categories
        $filtertag = $('.tags li'), //locate the filter Message
        ...
        setupFilters = function() {
            ...
            $btns.on('click', function(e) {
                ...
                if (!isActive) {
                    $('.portfolio-tab-sorting li a').removeClass('active');
                }
        ...
        setuptagFilters = function() {
            var $btntags = $filtertag.children();
            $btntags.on('click', function(e) {
                e.preventDefault();
                var $this = $(this),
                    isActive = $this.hasClass('active'),
                    group = isActive ? 'all' : $this.data('group');
